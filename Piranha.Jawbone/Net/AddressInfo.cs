...
public readonly struct AddressInfo
{
    ...
    public readonly ImmutableArray<Endpoint<Address128WithScopeId>> V6 { get; init; }

    public static AddressInfo Get(string? node, string? service)
    {
        var v4 = ArrayPool<Endpoint<Address32>>.Shared.Rent(64);
        var v6 = ArrayPool<Endpoint<Address128WithScopeId>>.Shared.Rent(64);
        ...
        var error = JawboneNetworking.GetAddressInfo(
            ...
            out var countV4,
            out v6[0],
            Unsafe.SizeOf<Endpoint<Address128WithScopeId>>(),
            v6.Length,
            out var countV6);
        ...
        ArrayPool<Endpoint<Address128WithScopeId>>.Shared.Return(v6);
