...
namespace Piranha.Jawbone.Tools
{
    ...
    public static class BufferExtensions
    {
        public static void AddQuad(
            this Buffer<float> buffer,
            in Quadrilateral position,
            in Quadrilateral textureCoordinates,
            int sheetLayer)
        {
            var layer = (float)sheetLayer;
            buffer.Add(position.A.X);
            buffer.Add(position.A.Y);
            buffer.Add(textureCoordinates.A.X);
            buffer.Add(textureCoordinates.A.Y);
            buffer.Add(layer);

            buffer.Add(position.B.X);
            buffer.Add(position.B.Y);
            buffer.Add(textureCoordinates.B.X);
            buffer.Add(textureCoordinates.B.Y);
            buffer.Add(layer);

            buffer.Add(position.C.X);
            buffer.Add(position.C.Y);
            buffer.Add(textureCoordinates.C.X);
            buffer.Add(textureCoordinates.C.Y);
            buffer.Add(layer);
            ...
            buffer.Add(position.D.X);
            buffer.Add(position.D.Y);
            buffer.Add(textureCoordinates.D.X);
            buffer.Add(textureCoordinates.D.Y);
            buffer.Add(layer);
        }
    }
}
