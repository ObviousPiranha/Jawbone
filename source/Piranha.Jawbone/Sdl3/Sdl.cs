...
public static partial class Sdl
{
    ...
    public static partial byte SetMemoryFunctions(nint malloc_func, nint calloc_func, nint realloc_func, nint free_func);
    ...
    public static partial nint CreateEnvironment(byte populated);
    ...
    public static partial byte SetEnvironmentVariable(nint env, nint name, nint value, byte overwrite);

    [LibraryImport(Lib, EntryPoint = "SDL_UnsetEnvironmentVariable")]
    public static partial byte UnsetEnvironmentVariable(nint env, nint name);
    ...
    public static partial byte SizeMulCheckOverflow(nuint a, nuint b, nint ret);

    [LibraryImport(Lib, EntryPoint = "SDL_size_mul_check_overflow_builtin")]
    public static partial byte SizeMulCheckOverflowBuiltin(nuint a, nuint b, nint ret);

    [LibraryImport(Lib, EntryPoint = "SDL_size_add_check_overflow")]
    public static partial byte SizeAddCheckOverflow(nuint a, nuint b, nint ret);

    [LibraryImport(Lib, EntryPoint = "SDL_size_add_check_overflow_builtin")]
    public static partial byte SizeAddCheckOverflowBuiltin(nuint a, nuint b, nint ret);
    ...
    public static partial byte TryLockSpinlock(nint @lock);
    ...
    public static partial byte CompareAndSwapAtomicInt(nint a, int oldval, int newval);
    ...
    public static partial byte CompareAndSwapAtomicU32(nint a, uint oldval, uint newval);
    ...
    public static partial byte CompareAndSwapAtomicPointer(nint a, nint oldval, nint newval);
    ...
    public static partial byte SetError(nint fmt);
    ...
    public static partial byte CopyProperties(uint src, uint dst);

    [LibraryImport(Lib, EntryPoint = "SDL_LockProperties")]
    public static partial byte LockProperties(uint props);
    ...
    public static partial byte SetPointerPropertyWithCleanup(uint props, nint name, nint value, nint cleanup, nint userdata);

    [LibraryImport(Lib, EntryPoint = "SDL_SetPointerProperty")]
    public static partial byte SetPointerProperty(uint props, nint name, nint value);

    [LibraryImport(Lib, EntryPoint = "SDL_SetStringProperty")]
    public static partial byte SetStringProperty(uint props, nint name, nint value);

    [LibraryImport(Lib, EntryPoint = "SDL_SetNumberProperty")]
    public static partial byte SetNumberProperty(uint props, nint name, long value);

    [LibraryImport(Lib, EntryPoint = "SDL_SetFloatProperty")]
    public static partial byte SetFloatProperty(uint props, nint name, float value);

    [LibraryImport(Lib, EntryPoint = "SDL_SetBooleanProperty")]
    public static partial byte SetBooleanProperty(uint props, nint name, byte value);

    [LibraryImport(Lib, EntryPoint = "SDL_HasProperty")]
    public static partial byte HasProperty(uint props, nint name);
    ...
    public static partial byte GetBooleanProperty(uint props, nint name, byte default_value);

    [LibraryImport(Lib, EntryPoint = "SDL_ClearProperty")]
    public static partial byte ClearProperty(uint props, nint name);

    [LibraryImport(Lib, EntryPoint = "SDL_EnumerateProperties")]
    public static partial byte EnumerateProperties(uint props, nint callback, nint userdata);
    ...
    public static partial byte SetCurrentThreadPriority(SdlThreadPriority priority);
    ...
    public static partial byte SetTLS(nint id, nint value, nint destructor);
    ...
    public static partial byte TryLockMutex(nint mutex);
    ...
    public static partial byte TryLockRWLockForReading(nint rwlock);

    [LibraryImport(Lib, EntryPoint = "SDL_TryLockRWLockForWriting")]
    public static partial byte TryLockRWLockForWriting(nint rwlock);
    ...
    public static partial byte TryWaitSemaphore(nint sem);

    [LibraryImport(Lib, EntryPoint = "SDL_WaitSemaphoreTimeout")]
    public static partial byte WaitSemaphoreTimeout(nint sem, int timeoutMS);
    ...
    public static partial byte WaitConditionTimeout(nint cond, nint mutex, int timeoutMS);

    [LibraryImport(Lib, EntryPoint = "SDL_ShouldInit")]
    public static partial byte ShouldInit(nint state);

    [LibraryImport(Lib, EntryPoint = "SDL_ShouldQuit")]
    public static partial byte ShouldQuit(nint state);

    [LibraryImport(Lib, EntryPoint = "SDL_SetInitialized")]
    public static partial void SetInitialized(nint state, byte initialized);
    ...
    public static partial byte CloseIO(nint context);
    ...
    public static partial byte FlushIO(nint context);

    [LibraryImport(Lib, EntryPoint = "SDL_LoadFile_IO")]
    public static partial nint LoadFileIO(nint src, nint datasize, byte closeio);
    ...
    public static partial byte ReadU8(nint src, nint value);

    [LibraryImport(Lib, EntryPoint = "SDL_ReadS8")]
    public static partial byte ReadS8(nint src, nint value);

    [LibraryImport(Lib, EntryPoint = "SDL_ReadU16LE")]
    public static partial byte ReadU16LE(nint src, nint value);

    [LibraryImport(Lib, EntryPoint = "SDL_ReadS16LE")]
    public static partial byte ReadS16LE(nint src, nint value);

    [LibraryImport(Lib, EntryPoint = "SDL_ReadU16BE")]
    public static partial byte ReadU16BE(nint src, nint value);

    [LibraryImport(Lib, EntryPoint = "SDL_ReadS16BE")]
    public static partial byte ReadS16BE(nint src, nint value);

    [LibraryImport(Lib, EntryPoint = "SDL_ReadU32LE")]
    public static partial byte ReadU32LE(nint src, nint value);

    [LibraryImport(Lib, EntryPoint = "SDL_ReadS32LE")]
    public static partial byte ReadS32LE(nint src, nint value);

    [LibraryImport(Lib, EntryPoint = "SDL_ReadU32BE")]
    public static partial byte ReadU32BE(nint src, nint value);

    [LibraryImport(Lib, EntryPoint = "SDL_ReadS32BE")]
    public static partial byte ReadS32BE(nint src, nint value);

    [LibraryImport(Lib, EntryPoint = "SDL_ReadU64LE")]
    public static partial byte ReadU64LE(nint src, nint value);

    [LibraryImport(Lib, EntryPoint = "SDL_ReadS64LE")]
    public static partial byte ReadS64LE(nint src, nint value);

    [LibraryImport(Lib, EntryPoint = "SDL_ReadU64BE")]
    public static partial byte ReadU64BE(nint src, nint value);

    [LibraryImport(Lib, EntryPoint = "SDL_ReadS64BE")]
    public static partial byte ReadS64BE(nint src, nint value);

    [LibraryImport(Lib, EntryPoint = "SDL_WriteU8")]
    public static partial byte WriteU8(nint dst, byte value);

    [LibraryImport(Lib, EntryPoint = "SDL_WriteS8")]
    public static partial byte WriteS8(nint dst, sbyte value);

    [LibraryImport(Lib, EntryPoint = "SDL_WriteU16LE")]
    public static partial byte WriteU16LE(nint dst, ushort value);

    [LibraryImport(Lib, EntryPoint = "SDL_WriteS16LE")]
    public static partial byte WriteS16LE(nint dst, short value);

    [LibraryImport(Lib, EntryPoint = "SDL_WriteU16BE")]
    public static partial byte WriteU16BE(nint dst, ushort value);

    [LibraryImport(Lib, EntryPoint = "SDL_WriteS16BE")]
    public static partial byte WriteS16BE(nint dst, short value);

    [LibraryImport(Lib, EntryPoint = "SDL_WriteU32LE")]
    public static partial byte WriteU32LE(nint dst, uint value);

    [LibraryImport(Lib, EntryPoint = "SDL_WriteS32LE")]
    public static partial byte WriteS32LE(nint dst, int value);

    [LibraryImport(Lib, EntryPoint = "SDL_WriteU32BE")]
    public static partial byte WriteU32BE(nint dst, uint value);

    [LibraryImport(Lib, EntryPoint = "SDL_WriteS32BE")]
    public static partial byte WriteS32BE(nint dst, int value);

    [LibraryImport(Lib, EntryPoint = "SDL_WriteU64LE")]
    public static partial byte WriteU64LE(nint dst, ulong value);

    [LibraryImport(Lib, EntryPoint = "SDL_WriteS64LE")]
    public static partial byte WriteS64LE(nint dst, long value);

    [LibraryImport(Lib, EntryPoint = "SDL_WriteU64BE")]
    public static partial byte WriteU64BE(nint dst, ulong value);

    [LibraryImport(Lib, EntryPoint = "SDL_WriteS64BE")]
    public static partial byte WriteS64BE(nint dst, long value);
    ...
    public static partial byte GetAudioDeviceFormat(uint devid, nint spec, nint sample_frames);
    ...
    public static partial byte PauseAudioDevice(uint dev);

    [LibraryImport(Lib, EntryPoint = "SDL_ResumeAudioDevice")]
    public static partial byte ResumeAudioDevice(uint dev);

    [LibraryImport(Lib, EntryPoint = "SDL_AudioDevicePaused")]
    public static partial byte AudioDevicePaused(uint dev);
    ...
    public static partial byte SetAudioDeviceGain(uint devid, float gain);
    ...
    public static partial byte BindAudioStreams(uint devid, nint streams, int num_streams);

    [LibraryImport(Lib, EntryPoint = "SDL_BindAudioStream")]
    public static partial byte BindAudioStream(uint devid, nint stream);
    ...
    public static partial byte GetAudioStreamFormat(nint stream, nint src_spec, nint dst_spec);

    [LibraryImport(Lib, EntryPoint = "SDL_SetAudioStreamFormat")]
    public static partial byte SetAudioStreamFormat(nint stream, nint src_spec, nint dst_spec);
    ...
    public static partial byte SetAudioStreamFrequencyRatio(nint stream, float ratio);
    ...
    public static partial byte SetAudioStreamGain(nint stream, float gain);
    ...
    public static partial byte SetAudioStreamInputChannelMap(nint stream, nint chmap, int count);

    [LibraryImport(Lib, EntryPoint = "SDL_SetAudioStreamOutputChannelMap")]
    public static partial byte SetAudioStreamOutputChannelMap(nint stream, nint chmap, int count);

    [LibraryImport(Lib, EntryPoint = "SDL_PutAudioStreamData")]
    public static partial byte PutAudioStreamData(nint stream, in byte buf, int len);

    [LibraryImport(Lib, EntryPoint = "SDL_PutAudioStreamData")]
    public static partial byte PutAudioStreamData(nint stream, in short buf, int len);

    [LibraryImport(Lib, EntryPoint = "SDL_PutAudioStreamData")]
    public static partial byte PutAudioStreamData(nint stream, in float buf, int len);
    ...
    public static partial byte FlushAudioStream(nint stream);

    [LibraryImport(Lib, EntryPoint = "SDL_ClearAudioStream")]
    public static partial byte ClearAudioStream(nint stream);

    [LibraryImport(Lib, EntryPoint = "SDL_PauseAudioStreamDevice")]
    public static partial byte PauseAudioStreamDevice(nint stream);

    [LibraryImport(Lib, EntryPoint = "SDL_ResumeAudioStreamDevice")]
    public static partial byte ResumeAudioStreamDevice(nint stream);

    [LibraryImport(Lib, EntryPoint = "SDL_LockAudioStream")]
    public static partial byte LockAudioStream(nint stream);

    [LibraryImport(Lib, EntryPoint = "SDL_UnlockAudioStream")]
    public static partial byte UnlockAudioStream(nint stream);

    [LibraryImport(Lib, EntryPoint = "SDL_SetAudioStreamGetCallback")]
    public static partial byte SetAudioStreamGetCallback(nint stream, nint callback, nint userdata);

    [LibraryImport(Lib, EntryPoint = "SDL_SetAudioStreamPutCallback")]
    public static partial byte SetAudioStreamPutCallback(nint stream, nint callback, nint userdata);
    ...
    public static partial byte SetAudioPostmixCallback(uint devid, nint callback, nint userdata);

    [LibraryImport(Lib, EntryPoint = "SDL_LoadWAV_IO")]
    public static partial byte LoadWAVIO(nint src, byte closeio, nint spec, nint audio_buf, nint audio_len);

    [LibraryImport(Lib, EntryPoint = "SDL_LoadWAV")]
    public static partial byte LoadWAV(nint path, nint spec, nint audio_buf, nint audio_len);

    [LibraryImport(Lib, EntryPoint = "SDL_MixAudio")]
    public static partial byte MixAudio(nint dst, nint src, SdlAudioFormat format, uint len, float volume);

    [LibraryImport(Lib, EntryPoint = "SDL_ConvertAudioSamples")]
    public static partial byte ConvertAudioSamples(nint src_spec, nint src_data, int src_len, nint dst_spec, nint dst_data, nint dst_len);
    ...
    public static partial byte HasExactlyOneBitSet32(uint x);
    ...
    public static partial byte GetMasksForPixelFormat(SdlPixelFormat format, nint bpp, nint Rmask, nint Gmask, nint Bmask, nint Amask);
    ...
    public static partial byte SetPaletteColors(nint palette, nint colors, int firstcolor, int ncolors);
    ...
    public static partial byte PointInRect(nint p, nint r);

    [LibraryImport(Lib, EntryPoint = "SDL_RectEmpty")]
    public static partial byte RectEmpty(nint r);

    [LibraryImport(Lib, EntryPoint = "SDL_RectsEqual")]
    public static partial byte RectsEqual(nint a, nint b);

    [LibraryImport(Lib, EntryPoint = "SDL_HasRectIntersection")]
    public static partial byte HasRectIntersection(nint A, nint B);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRectIntersection")]
    public static partial byte GetRectIntersection(nint A, nint B, nint result);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRectUnion")]
    public static partial byte GetRectUnion(nint A, nint B, nint result);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRectEnclosingPoints")]
    public static partial byte GetRectEnclosingPoints(nint points, int count, nint clip, nint result);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRectAndLineIntersection")]
    public static partial byte GetRectAndLineIntersection(nint rect, nint X1, nint Y1, nint X2, nint Y2);

    [LibraryImport(Lib, EntryPoint = "SDL_PointInRectFloat")]
    public static partial byte PointInRectFloat(nint p, nint r);

    [LibraryImport(Lib, EntryPoint = "SDL_RectEmptyFloat")]
    public static partial byte RectEmptyFloat(nint r);

    [LibraryImport(Lib, EntryPoint = "SDL_RectsEqualEpsilon")]
    public static partial byte RectsEqualEpsilon(nint a, nint b, float epsilon);

    [LibraryImport(Lib, EntryPoint = "SDL_RectsEqualFloat")]
    public static partial byte RectsEqualFloat(nint a, nint b);

    [LibraryImport(Lib, EntryPoint = "SDL_HasRectIntersectionFloat")]
    public static partial byte HasRectIntersectionFloat(nint A, nint B);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRectIntersectionFloat")]
    public static partial byte GetRectIntersectionFloat(nint A, nint B, nint result);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRectUnionFloat")]
    public static partial byte GetRectUnionFloat(nint A, nint B, nint result);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRectEnclosingPointsFloat")]
    public static partial byte GetRectEnclosingPointsFloat(nint points, int count, nint clip, nint result);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRectAndLineIntersectionFloat")]
    public static partial byte GetRectAndLineIntersectionFloat(nint rect, nint X1, nint Y1, nint X2, nint Y2);
    ...
    public static partial byte SetSurfaceColorspace(nint surface, SdlColorspace colorspace);
    ...
    public static partial byte SetSurfacePalette(nint surface, nint palette);
    ...
    public static partial byte AddSurfaceAlternateImage(nint surface, nint image);

    [LibraryImport(Lib, EntryPoint = "SDL_SurfaceHasAlternateImages")]
    public static partial byte SurfaceHasAlternateImages(nint surface);
    ...
    public static partial byte LockSurface(nint surface);
    ...
    public static partial nint LoadBMPIO(nint src, byte closeio);
    ...
    public static partial byte SaveBMPIO(nint surface, nint dst, byte closeio);

    [LibraryImport(Lib, EntryPoint = "SDL_SaveBMP")]
    public static partial byte SaveBMP(nint surface, nint file);

    [LibraryImport(Lib, EntryPoint = "SDL_SetSurfaceRLE")]
    public static partial byte SetSurfaceRLE(nint surface, byte enabled);

    [LibraryImport(Lib, EntryPoint = "SDL_SurfaceHasRLE")]
    public static partial byte SurfaceHasRLE(nint surface);

    [LibraryImport(Lib, EntryPoint = "SDL_SetSurfaceColorKey")]
    public static partial byte SetSurfaceColorKey(nint surface, byte enabled, uint key);

    [LibraryImport(Lib, EntryPoint = "SDL_SurfaceHasColorKey")]
    public static partial byte SurfaceHasColorKey(nint surface);

    [LibraryImport(Lib, EntryPoint = "SDL_GetSurfaceColorKey")]
    public static partial byte GetSurfaceColorKey(nint surface, nint key);

    [LibraryImport(Lib, EntryPoint = "SDL_SetSurfaceColorMod")]
    public static partial byte SetSurfaceColorMod(nint surface, byte r, byte g, byte b);

    [LibraryImport(Lib, EntryPoint = "SDL_GetSurfaceColorMod")]
    public static partial byte GetSurfaceColorMod(nint surface, nint r, nint g, nint b);

    [LibraryImport(Lib, EntryPoint = "SDL_SetSurfaceAlphaMod")]
    public static partial byte SetSurfaceAlphaMod(nint surface, byte alpha);

    [LibraryImport(Lib, EntryPoint = "SDL_GetSurfaceAlphaMod")]
    public static partial byte GetSurfaceAlphaMod(nint surface, nint alpha);

    [LibraryImport(Lib, EntryPoint = "SDL_SetSurfaceBlendMode")]
    public static partial byte SetSurfaceBlendMode(nint surface, uint blendMode);

    [LibraryImport(Lib, EntryPoint = "SDL_GetSurfaceBlendMode")]
    public static partial byte GetSurfaceBlendMode(nint surface, nint blendMode);

    [LibraryImport(Lib, EntryPoint = "SDL_SetSurfaceClipRect")]
    public static partial byte SetSurfaceClipRect(nint surface, nint rect);

    [LibraryImport(Lib, EntryPoint = "SDL_GetSurfaceClipRect")]
    public static partial byte GetSurfaceClipRect(nint surface, nint rect);

    [LibraryImport(Lib, EntryPoint = "SDL_FlipSurface")]
    public static partial byte FlipSurface(nint surface, SdlFlipMode flip);
    ...
    public static partial byte ConvertPixels(int width, int height, SdlPixelFormat src_format, nint src, int src_pitch, SdlPixelFormat dst_format, nint dst, int dst_pitch);

    [LibraryImport(Lib, EntryPoint = "SDL_ConvertPixelsAndColorspace")]
    public static partial byte ConvertPixelsAndColorspace(int width, int height, SdlPixelFormat src_format, SdlColorspace src_colorspace, uint src_properties, nint src, int src_pitch, SdlPixelFormat dst_format, SdlColorspace dst_colorspace, uint dst_properties, nint dst, int dst_pitch);

    [LibraryImport(Lib, EntryPoint = "SDL_PremultiplyAlpha")]
    public static partial byte PremultiplyAlpha(int width, int height, SdlPixelFormat src_format, nint src, int src_pitch, SdlPixelFormat dst_format, nint dst, int dst_pitch, byte linear);

    [LibraryImport(Lib, EntryPoint = "SDL_PremultiplySurfaceAlpha")]
    public static partial byte PremultiplySurfaceAlpha(nint surface, byte linear);

    [LibraryImport(Lib, EntryPoint = "SDL_ClearSurface")]
    public static partial byte ClearSurface(nint surface, float r, float g, float b, float a);

    [LibraryImport(Lib, EntryPoint = "SDL_FillSurfaceRect")]
    public static partial byte FillSurfaceRect(nint dst, nint rect, uint color);

    [LibraryImport(Lib, EntryPoint = "SDL_FillSurfaceRects")]
    public static partial byte FillSurfaceRects(nint dst, nint rects, int count, uint color);

    [LibraryImport(Lib, EntryPoint = "SDL_BlitSurface")]
    public static partial byte BlitSurface(nint src, nint srcrect, nint dst, nint dstrect);

    [LibraryImport(Lib, EntryPoint = "SDL_BlitSurfaceUnchecked")]
    public static partial byte BlitSurfaceUnchecked(nint src, nint srcrect, nint dst, nint dstrect);

    [LibraryImport(Lib, EntryPoint = "SDL_BlitSurfaceScaled")]
    public static partial byte BlitSurfaceScaled(nint src, nint srcrect, nint dst, nint dstrect, SdlScaleMode scaleMode);

    [LibraryImport(Lib, EntryPoint = "SDL_BlitSurfaceUncheckedScaled")]
    public static partial byte BlitSurfaceUncheckedScaled(nint src, nint srcrect, nint dst, nint dstrect, SdlScaleMode scaleMode);

    [LibraryImport(Lib, EntryPoint = "SDL_BlitSurfaceTiled")]
    public static partial byte BlitSurfaceTiled(nint src, nint srcrect, nint dst, nint dstrect);

    [LibraryImport(Lib, EntryPoint = "SDL_BlitSurfaceTiledWithScale")]
    public static partial byte BlitSurfaceTiledWithScale(nint src, nint srcrect, float scale, SdlScaleMode scaleMode, nint dst, nint dstrect);

    [LibraryImport(Lib, EntryPoint = "SDL_BlitSurface9Grid")]
    public static partial byte BlitSurface9Grid(nint src, nint srcrect, int left_width, int right_width, int top_height, int bottom_height, float scale, SdlScaleMode scaleMode, nint dst, nint dstrect);
    ...
    public static partial byte ReadSurfacePixel(nint surface, int x, int y, nint r, nint g, nint b, nint a);

    [LibraryImport(Lib, EntryPoint = "SDL_ReadSurfacePixelFloat")]
    public static partial byte ReadSurfacePixelFloat(nint surface, int x, int y, nint r, nint g, nint b, nint a);

    [LibraryImport(Lib, EntryPoint = "SDL_WriteSurfacePixel")]
    public static partial byte WriteSurfacePixel(nint surface, int x, int y, byte r, byte g, byte b, byte a);

    [LibraryImport(Lib, EntryPoint = "SDL_WriteSurfacePixelFloat")]
    public static partial byte WriteSurfacePixelFloat(nint surface, int x, int y, float r, float g, float b, float a);
    ...
    public static partial CString GetCameraDriver(int index);
    ...
    public static partial byte GetCameraFormat(nint camera, nint spec);
    ...
    public static partial byte SetClipboardText(nint text);
    ...
    public static partial byte HasClipboardText();

    [LibraryImport(Lib, EntryPoint = "SDL_SetPrimarySelectionText")]
    public static partial byte SetPrimarySelectionText(nint text);
    ...
    public static partial byte HasPrimarySelectionText();

    [LibraryImport(Lib, EntryPoint = "SDL_SetClipboardData")]
    public static partial byte SetClipboardData(nint callback, nint cleanup, nint userdata, nint mime_types, nuint num_mime_types);

    [LibraryImport(Lib, EntryPoint = "SDL_ClearClipboardData")]
    public static partial byte ClearClipboardData();
    ...
    public static partial byte HasClipboardData(nint mime_type);
    ...
    public static partial byte GetDisplayBounds(uint displayID, nint rect);

    [LibraryImport(Lib, EntryPoint = "SDL_GetDisplayUsableBounds")]
    public static partial byte GetDisplayUsableBounds(uint displayID, nint rect);
    ...
    public static partial byte GetClosestFullscreenDisplayMode(uint displayID, int w, int h, float refresh_rate, byte include_high_density_modes, nint mode);
    ...
    public static partial byte SetWindowFullscreenMode(nint window, nint mode);
    ...
    public static partial byte SetWindowTitle(nint window, nint title);
    ...
    public static partial byte SetWindowIcon(nint window, nint icon);

    [LibraryImport(Lib, EntryPoint = "SDL_SetWindowPosition")]
    public static partial byte SetWindowPosition(nint window, int x, int y);

    [LibraryImport(Lib, EntryPoint = "SDL_GetWindowPosition")]
    public static partial byte GetWindowPosition(nint window, nint x, nint y);

    [LibraryImport(Lib, EntryPoint = "SDL_SetWindowSize")]
    public static partial byte SetWindowSize(nint window, int w, int h);

    [LibraryImport(Lib, EntryPoint = "SDL_GetWindowSize")]
    public static partial byte GetWindowSize(nint window, out int w, out int h);

    [LibraryImport(Lib, EntryPoint = "SDL_GetWindowSafeArea")]
    public static partial byte GetWindowSafeArea(nint window, nint rect);

    [LibraryImport(Lib, EntryPoint = "SDL_SetWindowAspectRatio")]
    public static partial byte SetWindowAspectRatio(nint window, float min_aspect, float max_aspect);

    [LibraryImport(Lib, EntryPoint = "SDL_GetWindowAspectRatio")]
    public static partial byte GetWindowAspectRatio(nint window, nint min_aspect, nint max_aspect);

    [LibraryImport(Lib, EntryPoint = "SDL_GetWindowBordersSize")]
    public static partial byte GetWindowBordersSize(nint window, nint top, nint left, nint bottom, nint right);

    [LibraryImport(Lib, EntryPoint = "SDL_GetWindowSizeInPixels")]
    public static partial byte GetWindowSizeInPixels(nint window, nint w, nint h);

    [LibraryImport(Lib, EntryPoint = "SDL_SetWindowMinimumSize")]
    public static partial byte SetWindowMinimumSize(nint window, int min_w, int min_h);

    [LibraryImport(Lib, EntryPoint = "SDL_GetWindowMinimumSize")]
    public static partial byte GetWindowMinimumSize(nint window, nint w, nint h);

    [LibraryImport(Lib, EntryPoint = "SDL_SetWindowMaximumSize")]
    public static partial byte SetWindowMaximumSize(nint window, int max_w, int max_h);

    [LibraryImport(Lib, EntryPoint = "SDL_GetWindowMaximumSize")]
    public static partial byte GetWindowMaximumSize(nint window, nint w, nint h);

    [LibraryImport(Lib, EntryPoint = "SDL_SetWindowBordered")]
    public static partial byte SetWindowBordered(nint window, byte bordered);

    [LibraryImport(Lib, EntryPoint = "SDL_SetWindowResizable")]
    public static partial byte SetWindowResizable(nint window, byte resizable);

    [LibraryImport(Lib, EntryPoint = "SDL_SetWindowAlwaysOnTop")]
    public static partial byte SetWindowAlwaysOnTop(nint window, byte on_top);

    [LibraryImport(Lib, EntryPoint = "SDL_ShowWindow")]
    public static partial byte ShowWindow(nint window);

    [LibraryImport(Lib, EntryPoint = "SDL_HideWindow")]
    public static partial byte HideWindow(nint window);

    [LibraryImport(Lib, EntryPoint = "SDL_RaiseWindow")]
    public static partial byte RaiseWindow(nint window);

    [LibraryImport(Lib, EntryPoint = "SDL_MaximizeWindow")]
    public static partial byte MaximizeWindow(nint window);

    [LibraryImport(Lib, EntryPoint = "SDL_MinimizeWindow")]
    public static partial byte MinimizeWindow(nint window);

    [LibraryImport(Lib, EntryPoint = "SDL_RestoreWindow")]
    public static partial byte RestoreWindow(nint window);

    [LibraryImport(Lib, EntryPoint = "SDL_SetWindowFullscreen")]
    public static partial byte SetWindowFullscreen(nint window, byte fullscreen);

    [LibraryImport(Lib, EntryPoint = "SDL_SyncWindow")]
    public static partial byte SyncWindow(nint window);

    [LibraryImport(Lib, EntryPoint = "SDL_WindowHasSurface")]
    public static partial byte WindowHasSurface(nint window);
    ...
    public static partial byte SetWindowSurfaceVSync(nint window, int vsync);

    [LibraryImport(Lib, EntryPoint = "SDL_GetWindowSurfaceVSync")]
    public static partial byte GetWindowSurfaceVSync(nint window, nint vsync);

    [LibraryImport(Lib, EntryPoint = "SDL_UpdateWindowSurface")]
    public static partial byte UpdateWindowSurface(nint window);

    [LibraryImport(Lib, EntryPoint = "SDL_UpdateWindowSurfaceRects")]
    public static partial byte UpdateWindowSurfaceRects(nint window, nint rects, int numrects);

    [LibraryImport(Lib, EntryPoint = "SDL_DestroyWindowSurface")]
    public static partial byte DestroyWindowSurface(nint window);

    [LibraryImport(Lib, EntryPoint = "SDL_SetWindowKeyboardGrab")]
    public static partial byte SetWindowKeyboardGrab(nint window, byte grabbed);

    [LibraryImport(Lib, EntryPoint = "SDL_SetWindowMouseGrab")]
    public static partial byte SetWindowMouseGrab(nint window, byte grabbed);

    [LibraryImport(Lib, EntryPoint = "SDL_GetWindowKeyboardGrab")]
    public static partial byte GetWindowKeyboardGrab(nint window);

    [LibraryImport(Lib, EntryPoint = "SDL_GetWindowMouseGrab")]
    public static partial byte GetWindowMouseGrab(nint window);
    ...
    public static partial byte SetWindowMouseRect(nint window, nint rect);
    ...
    public static partial byte SetWindowOpacity(nint window, float opacity);
    ...
    public static partial byte SetWindowParent(nint window, nint parent);

    [LibraryImport(Lib, EntryPoint = "SDL_SetWindowModal")]
    public static partial byte SetWindowModal(nint window, byte modal);

    [LibraryImport(Lib, EntryPoint = "SDL_SetWindowFocusable")]
    public static partial byte SetWindowFocusable(nint window, byte focusable);

    [LibraryImport(Lib, EntryPoint = "SDL_ShowWindowSystemMenu")]
    public static partial byte ShowWindowSystemMenu(nint window, int x, int y);

    [LibraryImport(Lib, EntryPoint = "SDL_SetWindowHitTest")]
    public static partial byte SetWindowHitTest(nint window, nint callback, nint callback_data);

    [LibraryImport(Lib, EntryPoint = "SDL_SetWindowShape")]
    public static partial byte SetWindowShape(nint window, nint shape);

    [LibraryImport(Lib, EntryPoint = "SDL_FlashWindow")]
    public static partial byte FlashWindow(nint window, SdlFlashOperation operation);
    ...
    public static partial byte ScreenSaverEnabled();

    [LibraryImport(Lib, EntryPoint = "SDL_EnableScreenSaver")]
    public static partial byte EnableScreenSaver();

    [LibraryImport(Lib, EntryPoint = "SDL_DisableScreenSaver")]
    public static partial byte DisableScreenSaver();

    [LibraryImport(Lib, EntryPoint = "SDL_GL_LoadLibrary")]
    public static partial byte GlLoadLibrary(nint path);
    ...
    [LibraryImport(Lib, EntryPoint = "SDL_EGL_GetProcAddress")]
    public static partial nint EglGetProcAddress(nint proc);
    ...
    public static partial byte GlExtensionSupported(nint extension);
    ...
    public static partial byte GlSetAttribute(SdlGlAttr attr, int value);

    [LibraryImport(Lib, EntryPoint = "SDL_GL_GetAttribute")]
    public static partial byte GlGetAttribute(SdlGlAttr attr, nint value);
    ...
    public static partial byte GlMakeCurrent(nint window, nint context);
    ...
    public static partial byte GlSetSwapInterval(int interval);

    [LibraryImport(Lib, EntryPoint = "SDL_GL_GetSwapInterval")]
    public static partial byte GlGetSwapInterval(out int interval);

    [LibraryImport(Lib, EntryPoint = "SDL_GL_SwapWindow")]
    public static partial byte GlSwapWindow(nint window);

    [LibraryImport(Lib, EntryPoint = "SDL_GL_DestroyContext")]
    public static partial byte GlDestroyContext(nint context);

    [LibraryImport(Lib, EntryPoint = "SDL_ShowOpenFileDialog")]
    public static partial void ShowOpenFileDialog(nint callback, nint userdata, nint window, nint filters, int nfilters, nint default_location, byte allow_many);
    ...
    public static partial void ShowOpenFolderDialog(nint callback, nint userdata, nint window, nint default_location, byte allow_many);
    ...
    public static partial byte GetSensorData(nint sensor, nint data, int num_values);
    ...
    public static partial byte HasJoystick();
    ...
    public static partial byte DetachVirtualJoystick(uint instance_id);

    [LibraryImport(Lib, EntryPoint = "SDL_IsJoystickVirtual")]
    public static partial byte IsJoystickVirtual(uint instance_id);

    [LibraryImport(Lib, EntryPoint = "SDL_SetJoystickVirtualAxis")]
    public static partial byte SetJoystickVirtualAxis(nint joystick, int axis, short value);

    [LibraryImport(Lib, EntryPoint = "SDL_SetJoystickVirtualBall")]
    public static partial byte SetJoystickVirtualBall(nint joystick, int ball, short xrel, short yrel);

    [LibraryImport(Lib, EntryPoint = "SDL_SetJoystickVirtualButton")]
    public static partial byte SetJoystickVirtualButton(nint joystick, int button, byte down);

    [LibraryImport(Lib, EntryPoint = "SDL_SetJoystickVirtualHat")]
    public static partial byte SetJoystickVirtualHat(nint joystick, int hat, byte value);

    [LibraryImport(Lib, EntryPoint = "SDL_SetJoystickVirtualTouchpad")]
    public static partial byte SetJoystickVirtualTouchpad(nint joystick, int touchpad, int finger, byte down, float x, float y, float pressure);

    [LibraryImport(Lib, EntryPoint = "SDL_SendJoystickVirtualSensorData")]
    public static partial byte SendJoystickVirtualSensorData(nint joystick, SdlSensorType type, ulong sensor_timestamp, nint data, int num_values);
    ...
    public static partial byte SetJoystickPlayerIndex(nint joystick, int player_index);
    ...
    public static partial byte JoystickConnected(nint joystick);
    ...
    public static partial byte JoystickEventsEnabled();
    ...
    public static partial byte GetJoystickAxisInitialState(nint joystick, int axis, nint state);

    [LibraryImport(Lib, EntryPoint = "SDL_GetJoystickBall")]
    public static partial byte GetJoystickBall(nint joystick, int ball, nint dx, nint dy);
    ...
    public static partial byte GetJoystickButton(nint joystick, int button);

    [LibraryImport(Lib, EntryPoint = "SDL_RumbleJoystick")]
    public static partial byte RumbleJoystick(nint joystick, ushort low_frequency_rumble, ushort high_frequency_rumble, uint duration_ms);

    [LibraryImport(Lib, EntryPoint = "SDL_RumbleJoystickTriggers")]
    public static partial byte RumbleJoystickTriggers(nint joystick, ushort left_rumble, ushort right_rumble, uint duration_ms);

    [LibraryImport(Lib, EntryPoint = "SDL_SetJoystickLED")]
    public static partial byte SetJoystickLED(nint joystick, byte red, byte green, byte blue);

    [LibraryImport(Lib, EntryPoint = "SDL_SendJoystickEffect")]
    public static partial byte SendJoystickEffect(nint joystick, nint data, int size);
    ...
    public static partial int AddGamepadMappingsFromIO(nint src, byte closeio);
    ...
    public static partial byte ReloadGamepadMappings();
    ...
    public static partial byte SetGamepadMapping(uint instance_id, nint mapping);

    [LibraryImport(Lib, EntryPoint = "SDL_HasGamepad")]
    public static partial byte HasGamepad();
    ...
    public static partial byte IsGamepad(uint instance_id);
    ...
    public static partial byte SetGamepadPlayerIndex(nint gamepad, int player_index);
    ...
    public static partial byte GamepadConnected(nint gamepad);
    ...
    public static partial byte GamepadEventsEnabled();
    ...
    public static partial byte GamepadHasAxis(nint gamepad, SdlGamepadAxis axis);
    ...
    public static partial byte GamepadHasButton(nint gamepad, SdlGamepadButton button);

    [LibraryImport(Lib, EntryPoint = "SDL_GetGamepadButton")]
    public static partial byte GetGamepadButton(nint gamepad, SdlGamepadButton button);
    ...
    public static partial byte GetGamepadTouchpadFinger(nint gamepad, int touchpad, int finger, nint down, nint x, nint y, nint pressure);

    [LibraryImport(Lib, EntryPoint = "SDL_GamepadHasSensor")]
    public static partial byte GamepadHasSensor(nint gamepad, SdlSensorType type);

    [LibraryImport(Lib, EntryPoint = "SDL_SetGamepadSensorEnabled")]
    public static partial byte SetGamepadSensorEnabled(nint gamepad, SdlSensorType type, byte enabled);

    [LibraryImport(Lib, EntryPoint = "SDL_GamepadSensorEnabled")]
    public static partial byte GamepadSensorEnabled(nint gamepad, SdlSensorType type);
    ...
    public static partial byte GetGamepadSensorData(nint gamepad, SdlSensorType type, nint data, int num_values);

    [LibraryImport(Lib, EntryPoint = "SDL_RumbleGamepad")]
    public static partial byte RumbleGamepad(nint gamepad, ushort low_frequency_rumble, ushort high_frequency_rumble, uint duration_ms);

    [LibraryImport(Lib, EntryPoint = "SDL_RumbleGamepadTriggers")]
    public static partial byte RumbleGamepadTriggers(nint gamepad, ushort left_rumble, ushort right_rumble, uint duration_ms);

    [LibraryImport(Lib, EntryPoint = "SDL_SetGamepadLED")]
    public static partial byte SetGamepadLED(nint gamepad, byte red, byte green, byte blue);

    [LibraryImport(Lib, EntryPoint = "SDL_SendGamepadEffect")]
    public static partial byte SendGamepadEffect(nint gamepad, nint data, int size);
    ...
    public static partial byte HasKeyboard();
    ...
    public static partial uint GetKeyFromScancode(SdlScancode scancode, ushort modstate, byte key_event);
    ...
    public static partial byte SetScancodeName(SdlScancode scancode, nint name);
    ...
    public static partial byte StartTextInput(nint window);

    [LibraryImport(Lib, EntryPoint = "SDL_StartTextInputWithProperties")]
    public static partial byte StartTextInputWithProperties(nint window, uint props);

    [LibraryImport(Lib, EntryPoint = "SDL_TextInputActive")]
    public static partial byte TextInputActive(nint window);

    [LibraryImport(Lib, EntryPoint = "SDL_StopTextInput")]
    public static partial byte StopTextInput(nint window);

    [LibraryImport(Lib, EntryPoint = "SDL_ClearComposition")]
    public static partial byte ClearComposition(nint window);

    [LibraryImport(Lib, EntryPoint = "SDL_SetTextInputArea")]
    public static partial byte SetTextInputArea(nint window, nint rect, int cursor);

    [LibraryImport(Lib, EntryPoint = "SDL_GetTextInputArea")]
    public static partial byte GetTextInputArea(nint window, nint rect, nint cursor);

    [LibraryImport(Lib, EntryPoint = "SDL_HasScreenKeyboardSupport")]
    public static partial byte HasScreenKeyboardSupport();

    [LibraryImport(Lib, EntryPoint = "SDL_ScreenKeyboardShown")]
    public static partial byte ScreenKeyboardShown(nint window);

    [LibraryImport(Lib, EntryPoint = "SDL_HasMouse")]
    public static partial byte HasMouse();
    ...
    public static partial byte WarpMouseGlobal(float x, float y);

    [LibraryImport(Lib, EntryPoint = "SDL_SetWindowRelativeMouseMode")]
    public static partial byte SetWindowRelativeMouseMode(nint window, byte enabled);

    [LibraryImport(Lib, EntryPoint = "SDL_GetWindowRelativeMouseMode")]
    public static partial byte GetWindowRelativeMouseMode(nint window);

    [LibraryImport(Lib, EntryPoint = "SDL_CaptureMouse")]
    public static partial byte CaptureMouse(byte enabled);
    ...
    public static partial byte SetCursor(nint cursor);
    ...
    public static partial byte ShowCursor();

    [LibraryImport(Lib, EntryPoint = "SDL_HideCursor")]
    public static partial byte HideCursor();

    [LibraryImport(Lib, EntryPoint = "SDL_CursorVisible")]
    public static partial byte CursorVisible();
    ...
    public static partial byte HasEvent(uint type);

    [LibraryImport(Lib, EntryPoint = "SDL_HasEvents")]
    public static partial byte HasEvents(uint minType, uint maxType);
    ...
    public static partial byte PollEvent(out SdlEvent @event);

    [LibraryImport(Lib, EntryPoint = "SDL_WaitEvent")]
    public static partial byte WaitEvent(nint @event);

    [LibraryImport(Lib, EntryPoint = "SDL_WaitEventTimeout")]
    public static partial byte WaitEventTimeout(nint @event, int timeoutMS);

    [LibraryImport(Lib, EntryPoint = "SDL_PushEvent")]
    public static partial byte PushEvent(nint @event);
    ...
    public static partial byte GetEventFilter(nint filter, nint userdata);

    [LibraryImport(Lib, EntryPoint = "SDL_AddEventWatch")]
    public static partial byte AddEventWatch(nint filter, nint userdata);
    ...
    public static partial byte EventEnabled(uint type);
    ...
    public static partial byte CreateDirectory(nint path);

    [LibraryImport(Lib, EntryPoint = "SDL_EnumerateDirectory")]
    public static partial byte EnumerateDirectory(nint path, nint callback, nint userdata);

    [LibraryImport(Lib, EntryPoint = "SDL_RemovePath")]
    public static partial byte RemovePath(nint path);

    [LibraryImport(Lib, EntryPoint = "SDL_RenamePath")]
    public static partial byte RenamePath(nint oldpath, nint newpath);

    [LibraryImport(Lib, EntryPoint = "SDL_CopyFile")]
    public static partial byte CopyFile(nint oldpath, nint newpath);

    [LibraryImport(Lib, EntryPoint = "SDL_GetPathInfo")]
    public static partial byte GetPathInfo(nint path, nint info);
    ...
    public static partial byte GPUSupportsShaderFormats(uint format_flags, nint name);

    [LibraryImport(Lib, EntryPoint = "SDL_GPUSupportsProperties")]
    public static partial byte GPUSupportsProperties(uint props);

    [LibraryImport(Lib, EntryPoint = "SDL_CreateGPUDevice")]
    public static partial nint CreateGPUDevice(uint format_flags, byte debug_mode, nint name);
    ...
    public static partial nint MapGPUTransferBuffer(nint device, nint transfer_buffer, byte cycle);
    ...
    public static partial void UploadToGPUTexture(nint copy_pass, nint source, nint destination, byte cycle);

    [LibraryImport(Lib, EntryPoint = "SDL_UploadToGPUBuffer")]
    public static partial void UploadToGPUBuffer(nint copy_pass, nint source, nint destination, byte cycle);

    [LibraryImport(Lib, EntryPoint = "SDL_CopyGPUTextureToTexture")]
    public static partial void CopyGPUTextureToTexture(nint copy_pass, nint source, nint destination, uint w, uint h, uint d, byte cycle);

    [LibraryImport(Lib, EntryPoint = "SDL_CopyGPUBufferToBuffer")]
    public static partial void CopyGPUBufferToBuffer(nint copy_pass, nint source, nint destination, uint size, byte cycle);
    ...
    public static partial byte WindowSupportsGPUSwapchainComposition(nint device, nint window, SdlGpuSwapchainComposition swapchain_composition);

    [LibraryImport(Lib, EntryPoint = "SDL_WindowSupportsGPUPresentMode")]
    public static partial byte WindowSupportsGPUPresentMode(nint device, nint window, SdlGpuPresentMode present_mode);

    [LibraryImport(Lib, EntryPoint = "SDL_ClaimWindowForGPUDevice")]
    public static partial byte ClaimWindowForGPUDevice(nint device, nint window);
    ...
    public static partial byte SetGPUSwapchainParameters(nint device, nint window, SdlGpuSwapchainComposition swapchain_composition, SdlGpuPresentMode present_mode);
    ...
    public static partial byte AcquireGPUSwapchainTexture(nint command_buffer, nint window, nint swapchain_texture, nint swapchain_texture_width, nint swapchain_texture_height);

    [LibraryImport(Lib, EntryPoint = "SDL_SubmitGPUCommandBuffer")]
    public static partial byte SubmitGPUCommandBuffer(nint command_buffer);
    ...
    public static partial byte WaitForGPUIdle(nint device);

    [LibraryImport(Lib, EntryPoint = "SDL_WaitForGPUFences")]
    public static partial byte WaitForGPUFences(nint device, byte wait_all, nint fences, uint num_fences);

    [LibraryImport(Lib, EntryPoint = "SDL_QueryGPUFence")]
    public static partial byte QueryGPUFence(nint device, nint fence);
    ...
    public static partial byte GPUTextureSupportsFormat(nint device, SdlGpuTextureFormat format, SdlGpuTextureType type, uint usage);

    [LibraryImport(Lib, EntryPoint = "SDL_GPUTextureSupportsSampleCount")]
    public static partial byte GPUTextureSupportsSampleCount(nint device, SdlGpuTextureFormat format, SdlGpuSampleCount sample_count);
    ...
    public static partial byte IsMouseHaptic();
    ...
    public static partial byte IsJoystickHaptic(nint joystick);
    ...
    public static partial byte HapticEffectSupported(nint haptic, nint effect);
    ...
    public static partial byte UpdateHapticEffect(nint haptic, int effect, nint data);

    [LibraryImport(Lib, EntryPoint = "SDL_RunHapticEffect")]
    public static partial byte RunHapticEffect(nint haptic, int effect, uint iterations);

    [LibraryImport(Lib, EntryPoint = "SDL_StopHapticEffect")]
    public static partial byte StopHapticEffect(nint haptic, int effect);
    ...
    public static partial byte GetHapticEffectStatus(nint haptic, int effect);

    [LibraryImport(Lib, EntryPoint = "SDL_SetHapticGain")]
    public static partial byte SetHapticGain(nint haptic, int gain);

    [LibraryImport(Lib, EntryPoint = "SDL_SetHapticAutocenter")]
    public static partial byte SetHapticAutocenter(nint haptic, int autocenter);

    [LibraryImport(Lib, EntryPoint = "SDL_PauseHaptic")]
    public static partial byte PauseHaptic(nint haptic);

    [LibraryImport(Lib, EntryPoint = "SDL_ResumeHaptic")]
    public static partial byte ResumeHaptic(nint haptic);

    [LibraryImport(Lib, EntryPoint = "SDL_StopHapticEffects")]
    public static partial byte StopHapticEffects(nint haptic);

    [LibraryImport(Lib, EntryPoint = "SDL_HapticRumbleSupported")]
    public static partial byte HapticRumbleSupported(nint haptic);

    [LibraryImport(Lib, EntryPoint = "SDL_InitHapticRumble")]
    public static partial byte InitHapticRumble(nint haptic);

    [LibraryImport(Lib, EntryPoint = "SDL_PlayHapticRumble")]
    public static partial byte PlayHapticRumble(nint haptic, float strength, uint length);

    [LibraryImport(Lib, EntryPoint = "SDL_StopHapticRumble")]
    public static partial byte StopHapticRumble(nint haptic);
    ...
    public static partial byte GetHintBoolean(nint name, byte default_value);

    [LibraryImport(Lib, EntryPoint = "SDL_AddHintCallback")]
    public static partial byte AddHintCallback(nint name, nint callback, nint userdata);
    ...
    public static partial byte Init(SdlInit flags);

    [LibraryImport(Lib, EntryPoint = "SDL_InitSubSystem")]
    public static partial byte InitSubSystem(uint flags);
    ...
    public static partial byte SetAppMetadata(nint appname, nint appversion, nint appidentifier);

    [LibraryImport(Lib, EntryPoint = "SDL_SetAppMetadataProperty")]
    public static partial byte SetAppMetadataProperty(nint name, nint value);
    ...
    public static partial byte SetLogPriorityPrefix(SdlLogPriority priority, nint prefix);
    ...
    public static partial byte ShowMessageBox(nint messageboxdata, nint buttonid);

    [LibraryImport(Lib, EntryPoint = "SDL_ShowSimpleMessageBox")]
    public static partial byte ShowSimpleMessageBox(uint flags, nint title, nint message, nint window);
    ...
    public static partial byte OpenURL(nint url);
    ...
    public static partial nint CreateProcess(nint args, byte pipe_stdio);
    ...
    public static partial byte KillProcess(nint process, byte force);

    [LibraryImport(Lib, EntryPoint = "SDL_WaitProcess")]
    public static partial byte WaitProcess(nint process, byte block, nint exitcode);
    ...
    public static partial byte CreateWindowAndRenderer(nint title, int width, int height, ulong window_flags, nint window, nint renderer);
    ...
    public static partial byte GetRenderOutputSize(nint renderer, nint w, nint h);

    [LibraryImport(Lib, EntryPoint = "SDL_GetCurrentRenderOutputSize")]
    public static partial byte GetCurrentRenderOutputSize(nint renderer, nint w, nint h);
    ...
    public static partial byte GetTextureSize(nint texture, nint w, nint h);

    [LibraryImport(Lib, EntryPoint = "SDL_SetTextureColorMod")]
    public static partial byte SetTextureColorMod(nint texture, byte r, byte g, byte b);

    [LibraryImport(Lib, EntryPoint = "SDL_SetTextureColorModFloat")]
    public static partial byte SetTextureColorModFloat(nint texture, float r, float g, float b);

    [LibraryImport(Lib, EntryPoint = "SDL_GetTextureColorMod")]
    public static partial byte GetTextureColorMod(nint texture, nint r, nint g, nint b);

    [LibraryImport(Lib, EntryPoint = "SDL_GetTextureColorModFloat")]
    public static partial byte GetTextureColorModFloat(nint texture, nint r, nint g, nint b);

    [LibraryImport(Lib, EntryPoint = "SDL_SetTextureAlphaMod")]
    public static partial byte SetTextureAlphaMod(nint texture, byte alpha);

    [LibraryImport(Lib, EntryPoint = "SDL_SetTextureAlphaModFloat")]
    public static partial byte SetTextureAlphaModFloat(nint texture, float alpha);

    [LibraryImport(Lib, EntryPoint = "SDL_GetTextureAlphaMod")]
    public static partial byte GetTextureAlphaMod(nint texture, nint alpha);

    [LibraryImport(Lib, EntryPoint = "SDL_GetTextureAlphaModFloat")]
    public static partial byte GetTextureAlphaModFloat(nint texture, nint alpha);

    [LibraryImport(Lib, EntryPoint = "SDL_SetTextureBlendMode")]
    public static partial byte SetTextureBlendMode(nint texture, uint blendMode);

    [LibraryImport(Lib, EntryPoint = "SDL_GetTextureBlendMode")]
    public static partial byte GetTextureBlendMode(nint texture, nint blendMode);

    [LibraryImport(Lib, EntryPoint = "SDL_SetTextureScaleMode")]
    public static partial byte SetTextureScaleMode(nint texture, SdlScaleMode scaleMode);

    [LibraryImport(Lib, EntryPoint = "SDL_GetTextureScaleMode")]
    public static partial byte GetTextureScaleMode(nint texture, nint scaleMode);

    [LibraryImport(Lib, EntryPoint = "SDL_UpdateTexture")]
    public static partial byte UpdateTexture(nint texture, nint rect, nint pixels, int pitch);

    [LibraryImport(Lib, EntryPoint = "SDL_UpdateYUVTexture")]
    public static partial byte UpdateYUVTexture(nint texture, nint rect, nint Yplane, int Ypitch, nint Uplane, int Upitch, nint Vplane, int Vpitch);

    [LibraryImport(Lib, EntryPoint = "SDL_UpdateNVTexture")]
    public static partial byte UpdateNVTexture(nint texture, nint rect, nint Yplane, int Ypitch, nint UVplane, int UVpitch);

    [LibraryImport(Lib, EntryPoint = "SDL_LockTexture")]
    public static partial byte LockTexture(nint texture, nint rect, nint pixels, nint pitch);

    [LibraryImport(Lib, EntryPoint = "SDL_LockTextureToSurface")]
    public static partial byte LockTextureToSurface(nint texture, nint rect, nint surface);
    ...
    public static partial byte SetRenderTarget(nint renderer, nint texture);
    ...
    public static partial byte SetRenderLogicalPresentation(nint renderer, int w, int h, SdlRendererLogicalPresentation mode);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRenderLogicalPresentation")]
    public static partial byte GetRenderLogicalPresentation(nint renderer, nint w, nint h, nint mode);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRenderLogicalPresentationRect")]
    public static partial byte GetRenderLogicalPresentationRect(nint renderer, nint rect);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderCoordinatesFromWindow")]
    public static partial byte RenderCoordinatesFromWindow(nint renderer, float window_x, float window_y, nint x, nint y);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderCoordinatesToWindow")]
    public static partial byte RenderCoordinatesToWindow(nint renderer, float x, float y, nint window_x, nint window_y);

    [LibraryImport(Lib, EntryPoint = "SDL_ConvertEventToRenderCoordinates")]
    public static partial byte ConvertEventToRenderCoordinates(nint renderer, nint @event);

    [LibraryImport(Lib, EntryPoint = "SDL_SetRenderViewport")]
    public static partial byte SetRenderViewport(nint renderer, nint rect);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRenderViewport")]
    public static partial byte GetRenderViewport(nint renderer, nint rect);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderViewportSet")]
    public static partial byte RenderViewportSet(nint renderer);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRenderSafeArea")]
    public static partial byte GetRenderSafeArea(nint renderer, nint rect);

    [LibraryImport(Lib, EntryPoint = "SDL_SetRenderClipRect")]
    public static partial byte SetRenderClipRect(nint renderer, nint rect);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRenderClipRect")]
    public static partial byte GetRenderClipRect(nint renderer, nint rect);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderClipEnabled")]
    public static partial byte RenderClipEnabled(nint renderer);

    [LibraryImport(Lib, EntryPoint = "SDL_SetRenderScale")]
    public static partial byte SetRenderScale(nint renderer, float scaleX, float scaleY);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRenderScale")]
    public static partial byte GetRenderScale(nint renderer, nint scaleX, nint scaleY);

    [LibraryImport(Lib, EntryPoint = "SDL_SetRenderDrawColor")]
    public static partial byte SetRenderDrawColor(nint renderer, byte r, byte g, byte b, byte a);

    [LibraryImport(Lib, EntryPoint = "SDL_SetRenderDrawColorFloat")]
    public static partial byte SetRenderDrawColorFloat(nint renderer, float r, float g, float b, float a);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRenderDrawColor")]
    public static partial byte GetRenderDrawColor(nint renderer, nint r, nint g, nint b, nint a);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRenderDrawColorFloat")]
    public static partial byte GetRenderDrawColorFloat(nint renderer, nint r, nint g, nint b, nint a);

    [LibraryImport(Lib, EntryPoint = "SDL_SetRenderColorScale")]
    public static partial byte SetRenderColorScale(nint renderer, float scale);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRenderColorScale")]
    public static partial byte GetRenderColorScale(nint renderer, nint scale);

    [LibraryImport(Lib, EntryPoint = "SDL_SetRenderDrawBlendMode")]
    public static partial byte SetRenderDrawBlendMode(nint renderer, uint blendMode);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRenderDrawBlendMode")]
    public static partial byte GetRenderDrawBlendMode(nint renderer, nint blendMode);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderClear")]
    public static partial byte RenderClear(nint renderer);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderPoint")]
    public static partial byte RenderPoint(nint renderer, float x, float y);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderPoints")]
    public static partial byte RenderPoints(nint renderer, nint points, int count);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderLine")]
    public static partial byte RenderLine(nint renderer, float x1, float y1, float x2, float y2);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderLines")]
    public static partial byte RenderLines(nint renderer, nint points, int count);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderRect")]
    public static partial byte RenderRect(nint renderer, nint rect);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderRects")]
    public static partial byte RenderRects(nint renderer, nint rects, int count);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderFillRect")]
    public static partial byte RenderFillRect(nint renderer, nint rect);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderFillRects")]
    public static partial byte RenderFillRects(nint renderer, nint rects, int count);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderTexture")]
    public static partial byte RenderTexture(nint renderer, nint texture, nint srcrect, nint dstrect);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderTextureRotated")]
    public static partial byte RenderTextureRotated(nint renderer, nint texture, nint srcrect, nint dstrect, double angle, nint center, SdlFlipMode flip);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderTextureTiled")]
    public static partial byte RenderTextureTiled(nint renderer, nint texture, nint srcrect, float scale, nint dstrect);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderTexture9Grid")]
    public static partial byte RenderTexture9Grid(nint renderer, nint texture, nint srcrect, float left_width, float right_width, float top_height, float bottom_height, float scale, nint dstrect);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderGeometry")]
    public static partial byte RenderGeometry(nint renderer, nint texture, nint vertices, int num_vertices, nint indices, int num_indices);

    [LibraryImport(Lib, EntryPoint = "SDL_RenderGeometryRaw")]
    public static partial byte RenderGeometryRaw(nint renderer, nint texture, nint xy, int xy_stride, nint color, int color_stride, nint uv, int uv_stride, int num_vertices, nint indices, int num_indices, int size_indices);
    ...
    public static partial byte RenderPresent(nint renderer);
    ...
    public static partial byte FlushRenderer(nint renderer);
    ...
    public static partial byte AddVulkanRenderSemaphores(nint renderer, uint wait_stage_mask, long wait_semaphore, long signal_semaphore);

    [LibraryImport(Lib, EntryPoint = "SDL_SetRenderVSync")]
    public static partial byte SetRenderVSync(nint renderer, int vsync);

    [LibraryImport(Lib, EntryPoint = "SDL_GetRenderVSync")]
    public static partial byte GetRenderVSync(nint renderer, nint vsync);
    ...
    public static partial byte CloseStorage(nint storage);

    [LibraryImport(Lib, EntryPoint = "SDL_StorageReady")]
    public static partial byte StorageReady(nint storage);

    [LibraryImport(Lib, EntryPoint = "SDL_GetStorageFileSize")]
    public static partial byte GetStorageFileSize(nint storage, nint path, nint length);

    [LibraryImport(Lib, EntryPoint = "SDL_ReadStorageFile")]
    public static partial byte ReadStorageFile(nint storage, nint path, nint destination, ulong length);

    [LibraryImport(Lib, EntryPoint = "SDL_WriteStorageFile")]
    public static partial byte WriteStorageFile(nint storage, nint path, nint source, ulong length);

    [LibraryImport(Lib, EntryPoint = "SDL_CreateStorageDirectory")]
    public static partial byte CreateStorageDirectory(nint storage, nint path);

    [LibraryImport(Lib, EntryPoint = "SDL_EnumerateStorageDirectory")]
    public static partial byte EnumerateStorageDirectory(nint storage, nint path, nint callback, nint userdata);

    [LibraryImport(Lib, EntryPoint = "SDL_RemoveStoragePath")]
    public static partial byte RemoveStoragePath(nint storage, nint path);

    [LibraryImport(Lib, EntryPoint = "SDL_RenameStoragePath")]
    public static partial byte RenameStoragePath(nint storage, nint oldpath, nint newpath);

    [LibraryImport(Lib, EntryPoint = "SDL_CopyStorageFile")]
    public static partial byte CopyStorageFile(nint storage, nint oldpath, nint newpath);

    [LibraryImport(Lib, EntryPoint = "SDL_GetStoragePathInfo")]
    public static partial byte GetStoragePathInfo(nint storage, nint path, nint info);
    ...
    public static partial byte SetLinuxThreadPriority(long threadID, int priority);

    [LibraryImport(Lib, EntryPoint = "SDL_SetLinuxThreadPriorityAndPolicy")]
    public static partial byte SetLinuxThreadPriorityAndPolicy(long threadID, int sdlPriority, int schedPolicy);

    [LibraryImport(Lib, EntryPoint = "SDL_IsTablet")]
    public static partial byte IsTablet();

    [LibraryImport(Lib, EntryPoint = "SDL_IsTV")]
    public static partial byte IsTV();
    ...
    public static partial byte GetDateTimeLocalePreferences(nint dateFormat, nint timeFormat);

    [LibraryImport(Lib, EntryPoint = "SDL_GetCurrentTime")]
    public static partial byte GetCurrentTime(nint ticks);

    [LibraryImport(Lib, EntryPoint = "SDL_TimeToDateTime")]
    public static partial byte TimeToDateTime(long ticks, nint dt, byte localTime);

    [LibraryImport(Lib, EntryPoint = "SDL_DateTimeToTime")]
    public static partial byte DateTimeToTime(nint dt, nint ticks);
    ...
    public static partial byte RemoveTimer(uint id);
